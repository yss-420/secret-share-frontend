...
export const CompanionCard = ({ name, description, points, image, onStartChat }: CompanionCardProps) => {
  return (
    <Card className="card-premium transition-smooth group overflow-hidden">
      <div className="relative aspect-[4/5] overflow-hidden">
        ...
        />
        <div className="absolute bottom-2 right-2 backdrop-blur-sm bg-black/60 rounded-full px-1.5 py-0.5 flex items-center gap-1">

...
export const SocialFooter = ({ className = "" }: SocialFooterProps) => {
  const socialLinks = [
    ...
    },
    {
      ...
      icon: <img src={kofiLogo} alt="Ko-fi" className="w-5 h-5 object-contain" />,
    ...
    <div className={`flex justify-center items-center gap-6 py-4 ${className}`}>
      {socialLinks.map((social) => (
        <a
          ...
          className={`text-muted-foreground transition-all duration-200 flex items-center justify-center ${social.color}`}

    ...
    <div className="min-h-screen bg-background pb-8">
      ...
      <div className="px-4 py-3">
        ...
        <div className="space-y-6">
          ...
          {/* AI Rating Feature */}
          <Card className="card-premium transition-smooth p-6">
            <h3 className="text-lg font-semibold text-foreground mb-4">🎯 AI Rating Feature - Get Your Score</h3>
            <div className="space-y-4 text-sm text-muted-foreground">
              <div>
                <p className="text-foreground font-medium mb-2">What is the AI Rating Feature?</p>
                <p className="mb-2">The AI Rating Feature is our fun, AI-powered scoring system where you can get an instant, detailed score. Submit one clear photo, choose your preferred honesty level, and receive:</p>
                <p className="ml-4">• An instant score (out of 10)</p>
                <p className="ml-4">• A detailed, fun breakdown</p>
                <p className="ml-4 mb-2">• A private voice note reaction from your AI companion</p>
                <p>Your privacy is 100% protected - images are processed instantly and never saved.</p>
              </div>

              <div className="border-t border-border pt-4">
                <p className="text-foreground font-medium mb-2">How do I use it?</p>
                <p className="ml-4">1. Navigate to the feature from your chat menu</p>
                <p className="ml-4">2. Upload one clear, well-lit photo</p>
                <p className="ml-4">3. Choose your honesty level:</p>
                <p className="ml-8">• Honest - Realistic, balanced feedback</p>
                <p className="ml-8">• Brutally Honest - Direct critique</p>
                <p className="ml-8">• Flirty - Playful, encouraging, cheeky</p>
                <p className="ml-4">4. Receive your rating instantly!</p>
              </div>

              <div className="border-t border-border pt-4">
                <p className="text-foreground font-medium mb-2">How much does it cost?</p>
                <p className="mb-2">The feature costs 150 Gems per rating.</p>
                ...
                <p>After your passes run out, you can still use the feature for 150 Gems per rating!</p>
              </div>
              ...
              <div className="border-t border-border pt-4">
                ...
                <p className="ml-4 mb-2">Your rating is for your eyes only. No one else can see it.</p>
                <p className="mb-2">✅ No Humans Involved</p>
                <p className="ml-4 mb-2">The entire process is handled by advanced AI.</p>
                <p className="mb-2">✅ Images Are NEVER Saved</p>
                <p className="ml-4 mb-2">Your photo is processed instantly and deleted immediately after analysis.</p>
              ...
              <div className="border-t border-border pt-4">
                ...
                <p>Yes! You can use the feature as many times as you want. Each use costs 150 Gems (or 1 Rating Pass if you have a subscription). Try different angles, lighting, or honesty levels!</p>
              </div>

              <div className="border-t border-border pt-4">
                <p className="text-foreground font-medium mb-2">What if I'm not satisfied?</p>
                <p className="mb-2">Our AI provides objective analysis based on various factors. If you want a different perspective:</p>
                <p className="ml-4">• Try a different honesty level</p>
                <p className="ml-4">• Take a new photo with better lighting or angle</p>
          ...
          {/* Competitive Arena */}
          <Card className="card-premium transition-smooth p-6">
            <h3 className="text-lg font-semibold text-foreground mb-4">⚔️ Competitive Arena - Compete & Win</h3>
            <div className="space-y-4 text-sm text-muted-foreground">
              <div>
                <p className="text-foreground font-medium mb-2">What is Competitive Arena?</p>
                <p className="mb-2">Competitive Arena is our premium, competitive feature where you compete against real users in anonymous battles. Upload your entry, get AI-scored, and face off against another user's submission. Winners earn gems and climb the leaderboard for massive monthly rewards!</p>
              ...
              <div className="border-t border-border pt-4">
                ...
                <p className="ml-4">1. Navigate to the Arena from your menu</p>
                <p className="ml-4">2. Choose your Champion Name (permanent identity)</p>
                <p className="ml-4">3. Upload a clear photo of your entry</p>
                <p className="ml-4">4. Our AI scores your submission (1-10 scale)</p>
                <p className="ml-4">5. You're matched against another user's submission</p>
                <p className="ml-4">6. The higher score wins!</p>
              </div>

              <div className="border-t border-border pt-4">
                <p className="text-foreground font-medium mb-2">How does matchmaking work?</p>
                <p className="mb-2">When you enter a competition, the system tries to find you a live opponent for 60 seconds. If no one is available:</p>
                <p className="ml-4">• You're matched against a recent submission from our database</p>
              ...
              <div className="border-t border-border pt-4">
                ...
                <p className="mb-2">✅ Opponents can't see your photo</p>
                <p className="ml-4 mb-2">They only see their own score vs. yours. Photos are never shared.</p>
                <p className="mb-2">✅ Images are NEVER saved</p>
                <p className="ml-4 mb-2">Your photo is processed and deleted immediately after the competition.</p>
              ...
              <div className="border-t border-border pt-4">
                <p className="text-foreground font-medium mb-2">How much does it cost?</p>
                <p className="mb-2">Competitive Arena is included with your subscription!</p>
                <p className="mb-2">Free Competitions per Month:</p>
                <p className="ml-4">• Essential: 3 free entries</p>
                <p className="ml-4">• Plus: 5 free entries</p>
                <p className="ml-4 mb-2">• Premium: 10 free entries</p>
                <p className="mb-2">After your free entries:</p>
                <p className="ml-4 mb-2">• 200 Gems per additional competition</p>
              ...
              <div className="border-t border-border pt-4">
                ...
                <p>If you run out of passes, you can continue competing for 200 Gems per entry. Passes don't roll over!</p>
              </div>

              <div className="border-t border-border pt-4">
                <p className="text-foreground font-medium mb-2">What is the Leaderboard?</p>
                <p className="mb-2">The Competitive Arena features two leaderboards:</p>
                <p className="mb-2">🏆 All-Time Leaderboard</p>
                <p className="ml-4 mb-2">Tracks your total performance since you started competing.</p>
                ...
                <p className="ml-4">• Wins times 10</p>
                <p className="ml-4">• Win Rate times Wins</p>
                <p className="ml-4">• Best Win Streak times 5</p>
                <p className="ml-4 mb-2">• Losses times negative 2</p>
              ...
              <div className="border-t border-border pt-4">
                ...
                <p className="mb-2">Every month, the top performers win incredible prizes!</p>
                <p className="mb-2">🥇 1st Place</p>
                <p className="ml-4">• Premium Subscription (1 month)</p>
                <p className="ml-4">• 500 Gems</p>
                <p className="ml-4 mb-2">• Total Value: approximately 10 to 15 dollars</p>
                <p className="mb-2">🥈 2nd Place</p>
                <p className="ml-4">• Plus Subscription (1 month)</p>
                <p className="ml-4">• 300 Gems</p>
                <p className="ml-4 mb-2">• Total Value: approximately 7 to 10 dollars</p>
                <p className="mb-2">🥉 3rd Place</p>
                <p className="ml-4">• Essential Subscription (1 month)</p>
                <p className="ml-4">• 200 Gems</p>
                <p className="ml-4 mb-2">• Total Value: approximately 5 to 7 dollars</p>
                <p className="mb-2">💎 GEM REWARDS:</p>
                <p className="ml-4">• 4th to 5th Place: 200 Gems each</p>
                <p className="ml-4">• 6th to 10th Place: 150 Gems each</p>
                <p className="ml-4">• 11th to 25th Place: 100 Gems each</p>
                <p className="ml-4 mb-2">• 26th plus Place: 50 Gems each (requires 3 plus competitions)</p>
              ...
              <div className="border-t border-border pt-4">
                ...
                <p className="mb-2">1. Quality Photos Matter</p>
                <p className="ml-4 mb-2">Use good lighting, clear focus, and flattering angles for higher AI scores.</p>
                <p className="mb-2">2. Compete Regularly</p>
                <p className="ml-4 mb-2">The more you compete, the more chances to win and build your score.</p>
                <p className="mb-2">3. Build Win Streaks</p>
                <p className="ml-4 mb-2">Consecutive wins boost your Champion Score significantly!</p>
                <p className="mb-2">4. Time Your Competitions</p>
                <p className="ml-4 mb-2">Try competing when more users are active for better matchmaking.</p>
                <p className="mb-2">5. Learn from Losses</p>
                <p className="ml-4">Each competition is a learning experience. Adjust your strategy!</p>
              </div>
              ...
              <div className="border-t border-border pt-4">
                ...
                <p className="ml-4">• You can't compete until you resubscribe</p>
              ...
              <div className="border-t border-border pt-4">
                ...
                <p className="ml-4">• Photos must be appropriate and follow guidelines</p>
                ...
                <p className="mt-2">Battle for bragging rights and win massive rewards!</p>
              </div>
            </div>
          </Card>
          ...
          {/* Leaderboard Badges */}
          <Card className="card-premium transition-smooth p-6">
            <h3 className="text-lg font-semibold text-foreground mb-4">🏅 Leaderboard Badges - Top Champions</h3>
            <div className="space-y-4 text-sm text-muted-foreground">
              <div>
                <p className="text-foreground font-medium mb-2">What are Leaderboard Badges?</p>
                <p>In addition to ranking on the leaderboard, exceptional performers earn special badges showcasing their dominance!</p>
              </div>

              <div className="border-t border-border pt-4">
                <p className="text-foreground font-medium mb-2">Badge Categories</p>
                <p className="mb-2">🏆 Most Wins</p>
                <p className="ml-4 mb-2">Awarded to the champion with the highest number of victories.</p>
                <p className="ml-4 mb-2">Shows raw dominance - you've won more competitions than anyone else!</p>
                <p className="mb-2">🎯 Best Win Rate</p>
                <p className="ml-4 mb-2">Awarded to the champion with the highest win percentage.</p>
                <p className="ml-4 mb-2">Requires minimum 10 competitions to qualify.</p>
              ...
              <div className="border-t border-border pt-4">
                ...
                <p>However, having a badge shows you're a top-tier competitor!</p>
              </div>

              <div className="border-t border-border pt-4">
                <p className="text-foreground font-medium mb-2">Can I win multiple badges?</p>
                <p>Yes! If you dominate multiple categories (e.g., Most Wins AND Hottest Streak), you'll earn multiple badges. True champions collect them all!</p>
              </div>
              ...
              <div className="border-t border-border pt-4">
                ...
                <p className="mt-2">Earn your badges and prove you're a true champion!</p>
              </div>
            </div>
          </Card>

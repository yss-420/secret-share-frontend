...
-- Create RLS policies for chats table (using bigint for telegram_id)
...
-- Create RLS policies for images table (using uuid for user_id)
...
-- Create RLS policies for relationships table (using uuid for user_id)
...
-- Create RLS policies for transactions table (using uuid for user_id)
...
-- Create RLS policies for videos table (using uuid for user_id)
